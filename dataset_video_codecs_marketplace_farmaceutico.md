# Proposta metodológica e tabelas para dataset de vídeos
...
# Tabelas de organização do dataset

## Tabela 1 — Principais formatos por categoria de vídeo

| Formato / Categoria | Produto estático, embalagem, lettering | Educativo com apresentador/fala | Perfume / beleza cinematográfica | Comercial com cortes rápidos |
|---|---|---|---|---|
| H.264 / AVC — MP4 |  |  |  |  |
| ProRes 422 HQ — MOV |  |  |  |  |
| DNxHR HQX — MOV/MXF |  |  |  |  |
...
H.264 - Web, YouTube, redes sociais, cliente	.mp4 + H.264/AVC + AAC
ProRes 422 - Master profissional	.mov + Apple ProRes 422 + Linear PCM
ProRes 422 HQ - Master alta qualidade	.mov + Apple ProRes 422 HQ + Linear PCM
DNxHD/DNxHR - Master/intermediário Avid	.mov ou .mxf + DNxHD/DNxHR + Linear PCM

## Tabela 2 — Modelo para os 16 vídeos do dataset

| ID | Categoria | Descrição do vídeo | Formato de origem | Codec utilizado | Container | Resolução | FPS | Bit depth | Chroma | Áudio | Legendas/Texto | Observações |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P01 | Produto estático / embalagem / lettering |  |  |  |  |  |  |  |  |  |  |  |
| P02 | Produto estático / embalagem / lettering |  |  |  |  |  |  |  |  |  |  |  |
| P03 | Produto estático / embalagem / lettering |  |  |  |  |  |  |  |  |  |  |  |
| P04 | Produto estático / embalagem / lettering |  |  |  |  |  |  |  |  |  |  |  |
| E01 | Educativo com apresentador/fala |  |  |  |  |  |  |  |  |  |  |  |
| E02 | Educativo com apresentador/fala |  |  |  |  |  |  |  |  |  |  |  |
| E03 | Educativo com apresentador/fala |  |  |  |  |  |  |  |  |  |  |  |
| E04 | Educativo com apresentador/fala |  |  |  |  |  |  |  |  |  |  |  |
| F01 | Perfume / beleza cinematográfica |  |  |  |  |  |  |  |  |  |  |  |
| F02 | Perfume / beleza cinematográfica |  |  |  |  |  |  |  |  |  |  |  |
| F03 | Perfume / beleza cinematográfica |  |  |  |  |  |  |  |  |  |  |  |
| F04 | Perfume / beleza cinematográfica |  |  |  |  |  |  |  |  |  |  |  |
| C01 | Comercial com cortes rápidos |  |  |  |  |  |  |  |  |  |  |  |
| C02 | Comercial com cortes rápidos |  |  |  |  |  |  |  |  |  |  |  |
| C03 | Comercial com cortes rápidos |  |  |  |  |  |  |  |  |  |  |  |
| C04 | Comercial com cortes rápidos |  |  |  |  |  |  |  |  |  |  |  |
